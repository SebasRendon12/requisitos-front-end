...
function accesstab() {
    ...
    var mainwin1 = document.getElementsByClassName("tx-unal-accesibilidad")[0];
    if (document.getElementById("panel-accesibilidad").style.display === 'none') {
        ...
        openAccess(mainwin1, "tx-unal-accesibilidad-relative");
        ...
        closeAccess(mainwin1, "tx-unal-accesibilidad-relative");
    }
    var clase1 = "mainwin";
};
